 ...
 */
public class AppendCommand implements CommandExecutor {
    public boolean onCommand(CommandSender commandSender, Command command, String s, String[] strings) {
        if (commandSender.hasPermission("adminitem.bind")) {
            ...
            if (mainHandItem != null && mainHandItem.getType() != Material.AIR) {
                ...
                commandSender.sendMessage(ChatColor.GREEN + "This item is now an " + ChatColor.GOLD + "AdminItem");
            } else {
